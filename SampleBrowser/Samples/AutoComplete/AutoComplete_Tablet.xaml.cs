...
{
	public partial class AutoComplete_Tablet : SamplePage
	{
        ...
        Button closeButton;
		int minpref=1, maxDrop=100,pop=100,suggestion=0,autocompletemode=1;
        StackLayout view;
		Entry minPrefixCharacterText=null,maximumDropDownHeightText=null,PopupDelayText=null;
		PickerExt suggestionModepicker=null,autoCompleteModepicker=null;
        ...
        public void getPropertiesWindow()
        {
            ...
            suggestionModepicker = new PickerExt();
            autoCompleteModepicker = new PickerExt();
		...
		public void PrefixCharacter_Changed(object c,TextChangedEventArgs e)
		{
			if (minPrefixCharacterText != null) {
				if (e.NewTextValue.Length > 0) {
					countryAutoComplete.MinimumPrefixCharacters = int.Parse (e.NewTextValue);
					jobFieldAutoComplete.MinimumPrefixCharacters = int.Parse (e.NewTextValue);
		...
		public void MaximumHeight_Changed(object c,TextChangedEventArgs e)
		{
			if (maximumDropDownHeightText != null) {
				if (e.NewTextValue.Length > 0) {
					countryAutoComplete.MaximumDropDownHeight = int.Parse (e.NewTextValue);
					jobFieldAutoComplete.MaximumDropDownHeight = int.Parse (e.NewTextValue);
					maxDrop =  int.Parse (e.NewTextValue);
				}
			}
		...
		public void PopUp_Changed(object c,TextChangedEventArgs e)
		{
			...
			if (PopupDelayText != null) {
				if (e.NewTextValue.Length > 0) {
					countryAutoComplete.PopupDelay = int.Parse (e.NewTextValue);
					jobFieldAutoComplete.PopupDelay = int.Parse (e.NewTextValue);
					pop =  int.Parse (e.NewTextValue);
				}
			}
		}
