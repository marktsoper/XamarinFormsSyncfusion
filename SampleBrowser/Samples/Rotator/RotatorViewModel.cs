...
namespace SampleBrowser
{
    internal class RotatorViewModel
    {
        public RotatorViewModel()
        {
            ...
            {
                ImageCollection.Add(new RotatorModel("Icons/movie1.png"));
                ImageCollection.Add(new RotatorModel("Icons/movie2.png"));
                ImageCollection.Add(new RotatorModel("Icons/movie3.png"));
                ImageCollection.Add(new RotatorModel("Icons/movie4.png"));
                ImageCollection.Add(new RotatorModel("Icons/movie5.png"));
            }
        }
