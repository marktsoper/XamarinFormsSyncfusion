...
{
	public partial class KanbanCustomization
	{
		KanbanCustomViewModel model = new KanbanCustomViewModel();

		public KanbanCustomization()
		{
			InitializeComponent();
		...
		void Handle_DragEnd(object sender, Syncfusion.SfKanban.XForms.KanbanDragEndEventArgs e)
		{
		...
		void Handle_DragStart(object sender, Syncfusion.SfKanban.XForms.KanbanDragStartEventArgs e)
		{
			if ((e.Data as KanbanModel).Category.ToString() == "Menu")
				e.KeepItem = true;
		}

        void Handle_DragOver(object sender, Syncfusion.SfKanban.XForms.KanbanDragOverEventArgs e)
        {
