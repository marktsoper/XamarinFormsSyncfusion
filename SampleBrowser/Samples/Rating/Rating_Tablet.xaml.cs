...
{
	public partial class Rating_Tablet : SamplePage
	{
		...
		void optionView()
		{
			...
			if (Device.OS == TargetPlatform.iOS)
			{
				...
				column1.Width = 300;
				column2.Width = 350;
				movieImage.HeightRequest = 4 * App.ScreenHeight / 10;
				movieImage.WidthRequest = 300;
				imageHeight.Height = 4 * App.ScreenHeight / 10;
