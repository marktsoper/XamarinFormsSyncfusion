...
{
    [Activity(Label = "Sample Browser", Theme = "@android:style/Theme.Holo.Light", Icon = "@drawable/AppIcon", ConfigurationChanges = ConfigChanges.ScreenSize | ConfigChanges.Orientation)]
